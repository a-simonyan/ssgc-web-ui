<template>
  ...
  <a href="#" class="border-gray-300">
    ...
    <div class="card-body p-0">
      <!--begin::Name-->
      <h1 v-if="isHeader" class="fs-1 fw-bold text-dark w-220px">
        {{ title }}
      </h1>

      <div v-if="!isHeader" class="fs-3 fw-bold text-dark w-220px">
        {{ title }}
      </div>
      <!--end::Name-->

      <!--begin::Description-->
      <p class="text-muted fw-semobold fs-5 mt-1 mb-7">
        {{ getDescription }}
      </p>

      <a v-if="isReadMore" href="#" class="buttontext w-button border-bottom-solid fs-6 fw-semobold">Read more</a>
      <!--end::Description-->
